...
// import { registerUser, forgotPassword } from "../../services/authService";
...
//       return `You currently have ${employeesBehindSchedule.length} employee${
//         employeesBehindSchedule.length > 1 ? "s" : ""
...
//       await forgotPassword({ email: newEmail.trim() });

//       setAddMsg("Employee added and reset email sent!");
...
//               {!goalSaved && !companyGoal.trim() && (
//                 <p className="mt-2 text-sm text-slate-500">
//                   A clear goal helps HR align learning paths, hiring, and team development.
//                 </p>
//               )}
//             </div>
...
//                     {topPerformers[0]
//                       ? `${topPerformers[0].name} is leading with ${topPerformers[0].stars} completed skill${
//                           topPerformers[0].stars === 1 ? "" : "s"
//                         }.`
...
//             </h3>
//             <p className="text-sm text-slate-500">
//               Manage employees, assign roles, build your organization structure,
//               and create a culture of continuous learning.
//             </p>
//           </div>
//         </div>
//       </main>
...
//         <h3 className="mb-4 font-semibold text-slate-700">AI Assistant</h3>

//         <div className="space-y-3 text-sm">
//           <div className="rounded-xl border border-slate-100 bg-slate-50 p-4">
//             <p className="mb-1 font-medium text-slate-800">Hi Admin 👋</p>
//             <p className="text-slate-500">
//               Here’s a quick summary to guide your HR decisions today.
//             </p>
//           </div>

//           <div className="rounded-xl border border-slate-100 bg-white p-4 shadow-sm">
//             <p className="text-slate-700">
//               • {stats.totalEmployees} employees are currently in your system
//             </p>
//           </div>

//           <div className="rounded-xl border border-slate-100 bg-white p-4 shadow-sm">
//             <p className="text-slate-700">
//               • {stats.inProgress} skills are still in progress across the company
//             </p>
//           </div>
...
//                 : "Top performer data will appear here"}
//             </p>
//           </div>

//           <div className="rounded-xl border border-slate-100 bg-white p-4 shadow-sm">
//             <p className="text-slate-700">
//               • {employeesBehindSchedule.length} employees may need follow-up support
//             </p>
//           </div>

//           <div className="rounded-xl border border-purple-100 bg-purple-50 p-4">
//             <p className="mb-1 font-medium text-purple-800">Suggested HR Focus</p>
//             <p className="text-purple-700">
//               Check employees with many in-progress skills, celebrate top performers,
//               and align learning paths with the company goal.
//             </p>
//           </div>
//         </div>
//       </aside>
